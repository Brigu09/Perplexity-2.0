...
async def chat_stream(message: str, checkpoint_id: Optional[str] = Query(None)):
    return StreamingResponse(
        generate_chat_responses(message, checkpoint_id),   ## generator function stream intermediate events for langgraph node
        media_type="text/event-stream"      ## protocol for server-sent events
    )
